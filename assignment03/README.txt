...
Task B:
Step 1) Run taskA_2_create_test_files.py  (create the test_files)
Step 2) Run taskA_1.py (based on test_files create the database)
...
Task C:
Step 1) Run pip install watchdog
